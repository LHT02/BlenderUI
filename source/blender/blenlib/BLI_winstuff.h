...
/* Icon extraction is not here: it needs `IImageList`, which is a COM interface
 * and so cannot be used from this C header's translation unit. It lives in
 * GHOST - see `GHOST_LoadFileIconRgba()` in `GHOST_C-api.h`. */
