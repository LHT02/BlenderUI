@echo off
echo Starting BLUI with GPU debugging options, log files will be created
...
"%~dp0\BLUI" --debug --debug-gpu --python-expr "import bpy; bpy.ops.wm.sysinfo(filepath=r'%temp%\BLUI\debug_logs\BLUI_system_info.txt')" > "%temp%\BLUI\debug_logs\BLUI_debug_output.txt" 2>&1 < %0
